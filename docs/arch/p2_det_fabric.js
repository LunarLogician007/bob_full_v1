  ...
  D("clb", {
    ...
    notes: ["48 CLBs at x ∈ {1,2,4,5,7,8}, y 1…8. Each is <b>one BLE</b>: VPR's k6_frac_N10 packs 10 BLEs + local interconnect per cluster, which would cost far more configuration flip-flops than an XC7Z020 can hold as shift + shadow register pairs.",
    ...
    files: [["hw/src/clb/clb.sv", "the BLE"], ["hw/src/clb/lutk.sv", "K-input fracturable LUT"], ["hw/src/clb/clb_pkg.sv", "field offsets, INIT helpers"],
      ["hw/src/generated/bob_fabric.v", "48 instances u_clb_x*y*"], ["tools/bob/device.py", "clb fields, pins, VPR tile"],
  ...
  D("cbox", {
    ...
    why: ["Constants are common on hard-block pins; generating them in LUTs would waste CLBs out of 48."],
