#!/usr/bin/env python3
"""
Generate hw/tb/vectors.vh for hw/tb/tb_bob.v from software/host/designs.py,
software/host/bitstream.py, software/bob/model.py and software/bob/chainbits.py.

Each design is built and routed by the real bitstream engine; expected outputs
come from software/bob/model.py (which evaluates the same routing-resource graph
...
CRC, CFG_IN, JSTART), exactly as software/host/cfgplane.py does.
...
def main():
    ...
    out = [
        ...
        "//",
        f"// LUT K = {LUT_K}, chain {W} bits, {NCLB} CLBs. Bitstreams routed by software/host/bitstream.py,",
        "// expected values from software/bob/model.py, CRCs from software/bob/chainbits.py.",
        "",
    ]
