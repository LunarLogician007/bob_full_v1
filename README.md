...
| M24 | Double Duty elements (FPL 2025): the adder on two bypass inputs beside a free LUT; elements −4.7% (VPR) / −13.2% (bob's packer) | code done on branch `m24`; Vivado build next (`docs/hwtest/M24.md`) |
...
| JTAG | 6-bit AMD 7-series IR, IDCODE `0x0B024093` (M24) |
