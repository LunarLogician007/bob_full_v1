...
set_multicycle_path -setup 120 -from [get_cells -hier -filter {NAME =~ *u_clb/q_reg}] -to [get_cells -hier -filter {NAME =~ *u_dsp/*u_core/*}]
set_multicycle_path -hold  119 -from [get_cells -hier -filter {NAME =~ *u_clb/q_reg}] -to [get_cells -hier -filter {NAME =~ *u_dsp/*u_core/*}]
set_multicycle_path -setup 120 -from [get_cells -hier -filter {NAME =~ *u_dsp/*u_core/*}] -to [get_cells -hier -filter {NAME =~ *u_clb/q_reg}]
set_multicycle_path -hold  119 -from [get_cells -hier -filter {NAME =~ *u_dsp/*u_core/*}] -to [get_cells -hier -filter {NAME =~ *u_clb/q_reg}]
