...
// config word - tile 0 occupies bits [180:0], tile 1 bits [361:181], and so on.
//
...
// outgoing edge tracks are exposed the same way. The core above this decides
// which of them are wired to pads.
//
// The carry chain runs South to North up each column, so a column of four tiles
// is a four-bit adder. cin of the bottom row is the global carry in.
// -----------------------------------------------------------------------------
