...
# M5: BRAM tile (AMD UG473 RAMB18E1 behaviour, one inferred RAMB18)
src/tiles/bram_core.v
src/tiles/bram_jtag.v
src/tiles/bram_tile.v

# M6: DSP tile (AMD UG479 DSP48E1 behaviour, trimmed; two cascaded slices)
src/tiles/dsp_core.v
src/tiles/dsp_tile.v
