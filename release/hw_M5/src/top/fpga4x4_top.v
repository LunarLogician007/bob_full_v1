...
//
// Same pads as before, so the same harness and XDC pin assignments apply:
// SW1/SW0 and BTN3..0 are the fabric's input pads, LD0..LD2 its output pads,
// LD3 is DONE. M4 adds the 125 MHz board clock (sysclk, H16) for the fabric's
// user clock.
// -----------------------------------------------------------------------------
