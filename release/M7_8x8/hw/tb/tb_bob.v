...
module tb_bob;
    ...
    localparam        HALF     = 50;
    localparam [31:0] IDCODE   = 32'h9BEEF093;
    ...
    initial begin
        ...
        $display("");
        $display("[21] M7: 8-bit counter up the full height of column 8 (seven carry directs)");
        ...
        $display("  PASS  counter8 counted %0d consecutive TCK edges, through 255 -> 0", dchecks);
        write_user1(32'h0);
