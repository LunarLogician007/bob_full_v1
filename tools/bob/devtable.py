...
devtable.py - the device table, generated from the device description.
  ...
  tools/bob/devtable.py            print it
  tools/bob/devtable.py --write    update every file that carries the markers
  tools/bob/devtable.py --check    exit 1 if any marked block is out of date
