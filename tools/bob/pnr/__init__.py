...
pnr - bob's own pack, place and route in Python (M12a), checked against VPR.
  ...
  run.py       tools/bob/pnr/run.py <example> [--seed N]; compare.py: Python vs VPR report

The rr graph, pins and chain layout come from tools/bob/device.json (host/bitstream.py).
"""
